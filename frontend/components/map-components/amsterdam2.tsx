  ...
  const renderStadionplein = () => {
    return (
      <>
        ...
        <path style={styles.roomAvailable} d="M464,127h-12c-1.1,0-2-0.9-2-2v-25c0-1.1,0.9-2,2-2h25c1.1,0,2,0.9,2,2v25c0,0.7-0.4,1.3-0.9,1.7"/>
  ...
  const renderBeukenplein = () => {
    return (
      <>
        ...
        <path style={styles.roomAvailable} d="M352,113h-12c-1.1,0-2-0.9-2-2V86c0-1.1,0.9-2,2-2h25c1.1,0,2,0.9,2,2v25c0,0.8-0.5,1.5-1.2,1.8"/>    
  ...
  const renderWaterlooplein = () => {
    return (
      <>
        ...
        <path style={styles.roomAvailable} d="M309.2,112.8c-0.7-0.3-1.2-1-1.2-1.8V66c0-1.1,0.9-2,2-2h25c1.1,0,2,0.9,2,2v45c0,1.1-0.9,2-2,2h-12"/>
  ...
  const renderMuseumplein = () => {
    return (
      <>
        ...
        <path style={styles.roomAvailable} d="M192.9,114.5h-24.4c-1.8,0-3.3-0.8-3.3-1.8V90.8c0-1,1.5-1.8,3.3-1.8h40.6c1.8,0,3.3,0.8,3.3,1.8v21.9c0,1-1.4,1.8-3.3,1.8"/>
  ...
  const renderWeesperplein = () => {
    return (
      <>
        ...
        <path style={styles.roomAvailable} d="M138.3,114.5c-1.8,0-3.3-0.8-3.3-1.8V90.8c0-1,1.5-1.8,3.3-1.8H162c1.8,0,3.3,0.8,3.3,1.8v21.9c0,1-1.5,1.8-3.3,1.8h-7.4"/>
  ...
  const renderNieuwmarkt = () => {
    return (
      <>
        ...
        <path style={styles.roomAvailable} d="M55.1,110.3c0.5,0.4,0.9,1,0.9,1.7v25c0,1.1-0.9,2-2,2H29c-1.1,0-2-0.9-2-2v-25c0-1.1,0.9-2,2-2h12"/>
  ...
  const renderDeDam = () => {
    return (
      <>
        ...
        <path style={styles.roomUnAvailable} d="M610.5,73.5h13.4c1.1,0,2.1-0.9,2.1-2.1V27.6c0-1.1-0.9-2.1-2.1-2.1h-97.9c-1.1,0-2.1,0.9-2.1,2.1V57v12.5v2c0,1.1,0.9,2.1,2.1,2.1h70.4"/>
