  ...
  const renderEuropaplein = () => {
    return (
      <>
        ...
        {/* <text transform="matrix(1 0 0 1 378.9077 8.8788)">
  ...
  const renderSurinameplein = () => {
    return (
      <>
        ...
        <path style={styles.roomAvailable} d="M248.6,53.1h20.1c1.5,0,2.7,0.7,2.7,1.5v18.1c0,0.8-1.2,1.5-2.7,1.5h-33.6c-1.5,0-2.7-0.7-2.7-1.5V54.5
  ...
  const renderRembrandtplein = () => {
    return (
      <>
        ...
        {/* <text transform="matrix(1 0 0 1 511.9077 142.8788)">
          <tspan x="0" y="0" style={styles.availabilityText}>Available in </tspan>
          <tspan x="0" y="8.4" style={styles.availabilityText}>10 minutes</tspan>  
        </text>
  ...
  const renderAlexanderplein = () => {
    return (
      <>
        ...
        <text transform="matrix(1 0 0 1 571.9077 18.8788)">
          <tspan x="0" y="0" style={styles.availabilityText}>Available in </tspan>
          <tspan x="0" y="8.4" style={styles.availabilityText}>10 minutes</tspan>
        </text>
  ...
  const renderMuntplein = () => {
    return (
      <>
        ...
        <path style={styles.roomAvailable} d="M118.4,135.2v13.9c0,1-1,1.9-2.3,1.9H87.7c-1.3,0-2.3-0.8-2.3-1.9v-23.2c0-1,1-1.9,2.3-1.9h28.4
	c1.1,0,2,0.6,2.2,1.4"/>
        {/* <text transform="matrix(1 0 0 1 102.9077 172.8788)">
          <tspan x="0" y="0" style={styles.availabilityText}>Available in </tspan>
          <tspan x="0" y="8.4" style={styles.availabilityText}>10 minutes</tspan>
        </text>
  ...
  const renderVictorieplein = () => {
    return (
      <>
        ...
        <path style={styles.roomUnAvailable} d="M311.4,62.5v10.1c0,0.8-1.2,1.5-2.8,1.5h-34.4c-1.5,0-2.8-0.7-2.8-1.5V54.5c0-0.8,1.2-1.5,2.8-1.5h34.4
	c1.5,0,2.8,0.7,2.8,1.5v2.2"/>
        <text transform="matrix(1 0 0 1 286.9077 28.8788)">
          <tspan x="0" y="0" style={styles.availabilityText}>Available in </tspan>
          <tspan x="0" y="8.4" style={styles.availabilityText}>10 minutes</tspan>
        </text>
  ...
  const renderNoordermarkt = () => {
    return (
      <>
        ...
        />
        <text transform="matrix(1 0 0 1 18.9077 98.8788)">
          <tspan x="0" y="0" style={styles.availabilityText}>Available in </tspan>
          <tspan x="0" y="8.4" style={styles.availabilityText}>10 minutes</tspan>
        </text>
